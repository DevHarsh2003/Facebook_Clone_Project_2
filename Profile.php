            ...
            <center>
                <div class="row">
                    ...
                    <?php 
                         $con=mysqli_connect("localhost","root","");
                         $db=mysqli_select_db($con,"facebook");
                         $sql0="select * from user where username='$_SESSION[user]'";
                         $out0=mysqli_query($con,$sql0);
                         ?>
                        <div class="card bg-light">
                        <?php
                         while($row0=mysqli_fetch_assoc($out0)){
                    ?>
                          <div class="card-header" ><span style="float:left;"><i> <?php  echo $row0['name']; ?></i></span></div>
                            <div class="card-body">
                                <h4 style="float:left;"><i><?php  echo $row0['username']; ?></i></h4>
                            </div>
                                ...
                                if ($handle = opendir($path)) {
                                    while (false !== ($file = readdir($handle))) {
                                        ...
                                        if($file=="$u$n.jpg"){
                                            ...
                                            <div class="card-header" style="text-align:left;background-color:lightgrey"><i class="fa-solid fa-user fa-sm"></i>&nbsp;<?php echo $u; ?></div>
